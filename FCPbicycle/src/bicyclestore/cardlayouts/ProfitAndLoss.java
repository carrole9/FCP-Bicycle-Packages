...
public class ProfitAndLoss {
	...
	public void calculateTotalIncome(){
		double total =0;
		total = total + getSalesTransactionValue();
	...
	public void calculateSalesTransactionValue(){
		...
		for(SalesTransaction salesTransaction: salesTransactions){
			salestotalValue=salestotalValue + salesTransaction.getShoppingList().getTotalCostValue();
		
		}setSalesTransactionValue(salestotalValue);
		System.out.println(""+ salestotalValue);
	}
