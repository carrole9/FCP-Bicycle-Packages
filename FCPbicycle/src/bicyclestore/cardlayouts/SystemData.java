...
public class SystemData {
	...
	private void createSalesTransaction() {
		...
		SalesTransaction firstsale= new SalesTransaction(10001, database.getEmployee(10002),database.getCustomer("Tom Smith"),100.99, "Cash", yesterday, basket);
		database.addSalesTransaction(firstsale);
		
		SalesTransaction sale= new SalesTransaction(10002, database.getEmployee(10002),database.getCustomer("Freddy Mercury"),100.99, "Cash", yesterday, basket1);
		database.addSalesTransaction(sale);
		
		
		database.addSalesTransaction(new SalesTransaction(10003, database.getEmployee(10002),database.getCustomer("Patrick Dunne"),100.99, "Cash", yesterday, basket2));
