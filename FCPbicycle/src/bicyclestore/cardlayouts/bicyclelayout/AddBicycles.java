...
public class AddBicycles extends JPanel  {
	...
	public void checkFieldsComplete(){
		...
		// get bicycle details from text fields
				...
				// attempt to add bicycle if all fields are complete
					...
					addBicycle(type, model, colour, frameSize, wheelSize,frameComposition,costPrice,salePrice);
				}
		}
	
	public void addBicycle(String type,String model,String colour,String frameSize,String wheelSize,String frameComposition, String costPrice,String salePrice  ){
		int intFrameSize;
		int intWheelSize;
		...
		System.out.println(type+""+model+""+colour+costPrice+""+salePrice+""+frameSize+""+wheelSize+frameComposition+costPrice+salePrice);
			
		if(type.equals("BMX")){
			
		database.addBicycle(new BMX(model, colour, intFrameSize, intWheelSize,frameComposition, doubleCostPrice, doubleSalePrice));
		//database.getBicycles().add(new BMX(model, colour, intFrameSize, intWheelSize,frameComposition, doubleCostPrice, doubleSalePrice));
		}
		txtType.setText("");
		txtModel.setText("");
		txtColour.setText("");
	...
	public void confirmBicycleAdded(String type,String model,String colour,String frameSize,String wheelSize,String frameComposition, String costPrice,String salePrice){
